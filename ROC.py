...
z_bin = np.linspace(0.5, 2, 7);

for i in range(len(z_bin)):
    outputFileName = "C:/Users/" + userName  + r"/Dropbox/PhD/Courses/2019 - C - Fall/BMEN689 - ML and CV in BMEN/Project/prog/results/non_linear_SVM/" + timeStamp + '_5fold_SVM_nonlinear_c' + str(z_bin[i]) + 'very_clean.png'
    classifier = svm.SVC(kernel='rbf', C = z_bin[i] , probability=True)
